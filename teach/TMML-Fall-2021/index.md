...
+ Papers
  ...
  + [PAC-Bayesian Learning of Linear Classifiers](https://icml.cc/Conferences/2009/papers/89.pdf) (PAC-Bayesian derandomization for linear predictors)
  + [A PAC-Bayesian Approach to Spectrally-Normalized Margin Bounds for Neural Networks](https://arxiv.org/abs/1707.09564) (PAC-Bayesian results for DNNs)
  + [Studying generalization in deep learning via PAC-Bayes](https://www.ias.edu/sites/default/files/math/special_year_workshops/kdziugaite.pdf) (tutorial talk by Gintare Karolina Dziugaite)
  + [PAC-Bayesian Transportation Bound](https://arxiv.org/abs/1905.13435) (Abstract view of PAC Bayesian, and its connection to transportation bounds)
  + [Stability and Generalization](https://www.jmlr.org/papers/v2/bousquet02a.html) (classic results connecting stability and generalization)
  + [Learnability, Stability and Uniform Convergence](https://jmlr.csail.mit.edu/papers/volume11/shalev-shwartz10a/shalev-shwartz10a.pdf) (classic results connecting stability and generalization)
  + [Sharper bounds for uniformly stable algorithms](https://arxiv.org/abs/1910.07833) (state-of-the-art generalization bounds under uniform stability)
  + [Stability of Stochastic Gradient Descent on Nonsmooth Convex Losses](https://arxiv.org/abs/2006.06914) (algorithm stability of SGD on convex problems)
  + [Fine-Grained Analysis of Stability and Generalization for Stochastic Gradient Descent](https://arxiv.org/abs/2006.08157) (refined notion of stability for SGD on nonconvex problems)
  + [High probability generalization bounds for uniformly stable algorithms with nearly optimal rate](https://arxiv.org/abs/1902.10710) (high probability generalization bounds based on stability for convex problems)
  + [High-probability Convergence Bounds for Non-convex Stochastic Gradient Descent](https://arxiv.org/abs/2006.05610) (high probability generalization bounds based on stability for nonconvex problems under certain conditions)
  + [The Implicit Bias of Gradient Descent on Separable Data](https://jmlr.org/papers/v19/18-188.html) (Algorithm bias of GD on several classical learning models)
  + [Boosting with early stopping: Convergence and consistency](https://arxiv.org/abs/math/0508276) (Algorithm bias with coordinate descent on boosting models)
  + [Margins, Shrinkage, and Boosting](https://arxiv.org/abs/1303.4172) (Algorithm bias with coordinate descent on boosting models)
  + [Implicit Regularization via Hadamard Product Over-Parametrization in High-Dimensional Linear Regression](https://arxiv.org/abs/1903.09367) (Algorithm bias toward sparse solutions in linear regression)
  + [Implicit Regularization for Optimal Sparse Recovery](https://arxiv.org/abs/1909.05122) (Algorithm bias toward sparse solutions in linear regression)
  + [Algorithmic Regularization in Over-parameterized Matrix Sensing and Neural Networks with Quadratic Activations](https://arxiv.org/abs/1712.09203) (Algorithm bias in factorization)
  + [Implicit Regularization in Deep Matrix Factorization](https://arxiv.org/abs/1905.13655) (Algorithm bias in linear DNNs)
  + [Algorithmic Regularization in Learning Deep Homogeneous Models: Layers are Automatically Balanced](https://arxiv.org/abs/1806.00900) (Algorithm bias in DNNs)
  + [Implicit Regularization in Deep Learning May Not Be Explainable by Norms](https://arxiv.org/abs/2005.06398) (Difficulty in characterizing algorithm bias)
  + [On Margin Maximization in Linear and ReLU Networks](https://arxiv.org/abs/2110.02732) (Difficulty in characterizing algorithm bias)
  + [Reconciling modern machine learning practice and the bias-variance trade-off](https://arxiv.org/abs/1812.11118) (Initializes double descent study in modern machine learning)
  + [A brief prehistory of double descent](https://doi.org/10.1073/pnas.2001875117) (Double descent in early literature)
  + [Deep Double Descent: Where Bigger Models and More Data Hurt](https://arxiv.org/abs/1912.02292) (Double descent on computer vision datasets)
  + [Explaining the Success of AdaBoost and Random Forests as Interpolating Classifiers](https://www.jmlr.org/papers/volume18/15-240/15-240.pdf) (New explanation of the success of random forests and Adaboost as interpolating predictors)
  + [Benign Overfitting in Linear Regression](https://arxiv.org/abs/1906.11300) (Bias-variance characterization for linear regression with least L2 norm solution)
  + [Benign overfitting in ridge regression](https://arxiv.org/abs/2009.14286) (Bias-variance characterization for linear regression with least L2 norm solution, as well as ridge regression)
  + [Just interpolate: Kernel "ridgeless" regression can generalize](https://arxiv.org/abs/1808.00387) (Bias-variance characterization of the least L2 norm solution for kernel regression)
  + [On the Multiple Descent of Minimum-Norm Interpolants and Restricted Lower Isometry of Kernels](https://arxiv.org/abs/1908.10292) (Bias-variance characterization of the least L2 norm solution for kernel regression)
  + [Surprises in High-Dimensional Ridgeless Least Squares Interpolation](https://arxiv.org/abs/1903.08560) (Bias-variance characterization of the least L2 norm solution for kernel regression)
  + [Linearized two-layers neural networks in high dimension](https://arxiv.org/abs/1904.12191) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
  + [When Do Neural Networks Outperform Kernel Methods?](https://arxiv.org/abs/2006.13409) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
  + [Generalization error of random features and kernel methods: hypercontractivity and kernel matrix concentration](https://arxiv.org/abs/2101.10588) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
  + [The generalization error of random features regression: Precise asymptotics and double descent curve](https://arxiv.org/abs/1908.05355) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
  + [The Interpolation Phase Transition in Neural Networks: Memorization and Generalization under Lazy Training](https://arxiv.org/abs/2007.12826) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
  + [The Interplay Between Implicit Bias and Benign Overfitting in Two-Layer Linear Networks](https://arxiv.org/abs/2108.11489) (Bias-variance characterization of 1.5-layer NN in the linearization regime)
